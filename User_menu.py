...
class User:
    ...
    def user_input(self):
        ...
        entercart = mycombobox(
            self.entryframe, width=20, textvariable=self.additem, font="Montserrat 12"
        )
        ...
        Label(
            self.tableframe1,
            text="Invoice No. " + str(self.invoice),
            font="Montserrat 12 bold",
            bg="#12171c",
            fg="white",
        ).grid(row=0, column=0)
        ...
        Entry(
            self.entryframe1,
            textvariable=self.cartitemid,
            font="roboto 14",
            bg="#FFFFFF",
            width=25,
            state="readonly",
        ).place(x=162, y=0, height=40)
        Entry(
            self.entryframe1,
            textvariable=self.cartitem,
            font="roboto 14",
            bg="#FFFFFF",
            width=25,
            state="readonly",
        ).place(x=162, y=65, height=40)
        Entry(
            self.entryframe1,
            textvariable=self.cartitemprice,
            font="roboto 14",
            bg="#FFFFFF",
            width=25,
            state="readonly",
        ).place(x=162, y=65 * 2, height=40)
        Entry(
            self.entryframe1,
            textvariable=self.cartitemstock,
            font="roboto 14",
            bg="#FFFFFF",
            width=25,
            state="readonly",
        ).place(x=162, y=65 * 3, height=40)
        self.id_qty = dict()
    ...
    def addtotrans(self):
        if (
            len(self.additem.get()) == 0
            or self.inventory.count(self.additem.get()) == 0
        ):
